...
class PDFConvert {
    ...
    constructor(source, options) {
        this.ghostscriptPath = path_1.default.join(path_1.default.resolve('./'), "executables", "ghostScript");
        this.convertPageToImage = (page) => new Promise((resolve, reject) => {
            tmp_1.default.file({}, (err, name, fd) => __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    (0, child_process_1.exec)(cmd, (err, stdout, stderr) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        const buffer = yield (0, promises_1.readFile)(name);
                        yield (0, promises_1.unlink)(name);
        ...
        this.getPageCount = () => new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this.tempLocation) {
                try {
                    this.tempLocation = yield this.writePDFToTemp();
                }
                catch (e) {
         ...
         * @returns Filename
         */
        this.writePDFToTemp = () => new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            let file;
